...
-(void)setTabItemSelectedFontSize:(CGFloat)tabItemSelectedFontSize
{
    _tabItemSelectedFontSize = tabItemSelectedFontSize;
    
    UILabel *label = (UILabel *)[scrollView_ viewWithTag:kLabelTagBase+self.selectedIndex];
    label.font = [UIFont systemFontOfSize:_tabItemSelectedFontSize];
}
...
- (void)setTabbarItems:(NSArray *)tabbarItems{
    if (_tabbarItems != tabbarItems) {
        ...
        for (DLScrollTabbarItem *item in tabbarItems) {
            ...
            [label sizeToFit];
            label.width = [label sizeThatFits:label.size].width*1.5;
...
- (void)switchingFrom:(NSInteger)fromIndex to:(NSInteger)toIndex percent:(float)percent{
    ...
    fromLabel.font = [UIFont systemFontOfSize:self.tabItemSelectedFontSize - (self.tabItemSelectedFontSize - self.tabItemNormalFontSize) * percent];
    ...
    if (toIndex >= 0 && toIndex < [self tabbarCount]) {
        ...
        toLabel.font = [UIFont systemFontOfSize:self.tabItemNormalFontSize + (self.tabItemSelectedFontSize - self.tabItemNormalFontSize) * percent];
    }
...
- (void)setSelectedIndex:(NSInteger)selectedIndex{
    if (_selectedIndex != selectedIndex) {
        ...
        if (selectedIndex >= 0 && selectedIndex < [self tabbarCount]) {
            ...
            toLabel.font = [UIFont systemFontOfSize:self.tabItemSelectedFontSize];
