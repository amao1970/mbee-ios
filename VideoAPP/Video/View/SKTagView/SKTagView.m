...
- (void)layoutTags {
    ...
    self.didSetup = YES;
    NSLog(@"padding------%@",NSStringFromUIEdgeInsets(self.padding));
    self.height = self.subviews.lastObject.bottom + self.padding.bottom;
    NSLog(@"height------%@",NSStringFromCGRect(self.frame));
}
