//
//  SVCNovelViewController.m
//  SmartValleyCloudSeeding
//
//  Created by admxjx on 2018/11/21.
...
@interface SVCVideoViewController ()<DLCustomSlideViewDelegate>
...
@implementation SVCVideoViewController
...
-(void)getNetData{
    [SVCCommunityApi getVideoCategoryWithParams:nil BlockSuccess:^(NSInteger code, NSString *msg, NSArray *jsonArr) {
        if (code == 0) {
            self.requestFailed = NO;
...
- (UIViewController *)DLCustomSlideView:(DLCustomSlideView *)sender controllerAt:(NSInteger)index{
    ...
    SVCVideoTableViewController *vc = [[SVCVideoTableViewController alloc] initWithCategoryID:model.ID];
    return vc;
}
