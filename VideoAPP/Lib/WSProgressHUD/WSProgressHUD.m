...
#warning 这里修改了
                    [self.labelView addparagraphStyleWithCGFloat:3];
                    self.labelView.textAlignment=NSTextAlignmentCenter;
...
//     
        ...
        WSProgressHUDStringRect.size = [string boundingRectWithSize:constraintSize
                                                         ...
                                                         attributes:@{NSFontAttributeName: contentLabel.font,NSParagraphStyleAttributeName :paragraphStyle}
                                                            context:NULL].size;
        
    
        WSProgressHUDStringRect.size=CGSizeMake(WSProgressHUDStringRect.size.width*1.2, WSProgressHUDStringRect.size.height*1.2);
