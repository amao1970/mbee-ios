...
+(UIColor *)colorWithRGBString:(NSString *)rgbStr
{
    NSArray* rgbArray = [rgbStr componentsSeparatedByString:@"."];
    return [UIColor colorWithRed:[rgbArray[0] floatValue]/255.0 green:[rgbArray[1] floatValue]/255.0 blue:[rgbArray[2] floatValue]/255.0 alpha:1];
}
